    ...
    return (
        <div className='about_doc'>
            ...
            <main>
                <section>
                    <h2>Our Mission</h2>
                    <p>Introducing an innovative solution tailored to simplify the complexities of Sri Lanka's legal landscape. Born from the recognition of the daunting task regular citizens face in understanding and accessing the multifaceted legal systems inherited from various historical influences, including English common law, Roman-Dutch civil law, and customary laws like "Thesawalamai," our project aims to bridge the gap between the law and the layperson. With an intuitive online platform, LegalEase Sri Lanka offers accessible educational resources, a comprehensive database of laws, and a directory of legal aid services, all presented in multiple languages to cater to the diverse population of our nation. Through community forums and collaboration with legal experts, we aspire to empower individuals to navigate their legal rights and responsibilities confidently. Join us in our mission to democratize access to justice and foster legal empowerment for all Sri Lankans.</p>
                </section>
                <section>
